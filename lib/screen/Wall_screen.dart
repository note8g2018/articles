...
class Wall extends StatefulWidget
{
  ...
  => _WallState(articleW: article);
}

class _WallState extends State<Wall>
{
  Article articleW;
  _WallState({Key key, this.articleW});
 ...
 //   await _channel?.sink?.close(status.goingAway);
    const String url = 'ws://coolme.me:3050/sockserver/websocket';
...
//    const String url = 'http://192.168.1.100:8888/articleall';
    ...
    const String url = 'http://coolme.me:3000';
    String time;
